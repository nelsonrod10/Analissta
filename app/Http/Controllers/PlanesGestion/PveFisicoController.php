...
use App\PlanesGestion\PveFisicoLineaBase;
use App\PlanesGestion\PveFisicoMeta;

class PveFisicoController extends Controller
{
    ...
    private function guardarMetasIncidencia($idPve,$objetivo,$meta,$unidad){
        $existeIncidencia = PveFisicoMeta::where('pve_fisicos_id',$idPve)
        ...
        PveFisicoMeta::create([
           "nombreMeta" => 'Eficacia Incidencia',
           "pve_fisicos_id" => $idPve, 
           "objetivo" => $objetivo,
           "unidad"   => $unidad,
           "valorMeta"     => $meta, 
        ]);
    ...
    private function guardarMetasPrevalencia($idPve,$objetivo,$meta,$unidad){
        $existePrevalencia = PveFisicoMeta::where('pve_fisicos_id',$idPve)
    ...
    private function guardarMetasMortalidad($idPve,$objetivo,$meta,$unidad){
        $existeCasosNuevos = PveFisicoMeta::where('pve_fisicos_id',$idPve)
    ...
    private function lineaBaseIncidencia($idPve,$arrIncidencia){
        $existeBaseIncidencia = PveFisicoLineaBase::where('pve_fisicos_id',$idPve)
                ->where('nombreMeta','Eficacia Incidencia')
                ->get();
        ...
        if(count($existeBaseIncidencia)>0){
            ...
            $baseIncidencia = PveFisicoLineaBase::create([
                'pve_fisicos_id' => $idPve,
                'nombreMeta'      => 'Eficacia Incidencia',
             ]);
        }
    ...
    private function lineaBasePrevalencia($idPve,$arrPrevalencia){
        $existeBasePrevalencia = PveFisicoLineaBase::where('pve_fisicos_id',$idPve)
                ->where('nombreMeta','Eficacia Prevalencia')
                ->get();
        ...
        if(count($existeBasePrevalencia)>0){
            ...
            $basePrevalencia = PveFisicoLineaBase::create([
                'pve_fisicos_id' => $idPve,
                'nombreMeta'      => 'Eficacia Prevalencia',
             ]);
        }
    ...
    private function lineaBaseMortalidad($idPve,$arrMortalidad){
        $existeBaseCasosNuevos = PveFisicoLineaBase::where('pve_fisicos_id',$idPve)
                ->where('nombreMeta','Eficacia Casos Nuevos')
                ->get();
        ...
        if(count($existeBaseCasosNuevos)>0){
            ...
            $baseCasosNuevos = PveFisicoLineaBase::create([
                'pve_fisicos_id' => $idPve,
                'nombreMeta'      => 'Eficacia Casos Nuevos',
             ]);
        }
