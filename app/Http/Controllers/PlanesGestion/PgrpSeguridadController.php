...
use App\PlanesGestion\PgrpSeguridadLineaBase;
use App\PlanesGestion\PgrpSeguridadMeta;

class PgrpSeguridadController extends Controller
{
    public function guardarData(){
        ...
        PgrpSeguridade::where('id',$data['idPgrp'])
    ...
    private function guardarMetasFrecuencia($idPgrp,$objetivo,$meta,$unidad){
        $existeFrecuencia = PgrpSeguridadMeta::where('pgrp_seguridades_id',$idPgrp)
        ...
        PgrpSeguridadMeta::create([
           "nombreMeta" => 'Eficacia Frecuencia',
           "pgrp_seguridades_id" => $idPgrp, 
           "objetivo" => $objetivo,
           "unidad"   => $unidad,
           "valorMeta"     => $meta, 
        ]);
    ...
    private function guardarMetasSeveridad($idPgrp,$objetivo,$meta,$unidad){
        $existeSeveridad = PgrpSeguridadMeta::where('pgrp_seguridades_id',$idPgrp)
    ...
    private function guardarMetasIli($idPgrp,$objetivo,$meta,$unidad){
        $existeili = PgrpSeguridadMeta::where('pgrp_seguridades_id',$idPgrp)
    ...
    private function guardarMetasMortalidad($idPgrp,$objetivo,$meta,$unidad){
        $existeTasaMortalidad = PgrpSeguridadMeta::where('pgrp_seguridades_id',$idPgrp)
    ...
    private function lineaBaseFrecuencia($idPgrp,$arrFrecuencia){
        $existeBaseFrecuencia = PgrpSeguridadLineaBase::where('pgrp_seguridades_id',$idPgrp)
                ->where('nombreMeta','Eficacia Frecuencia')
                ->get();
        ...
        if(count($existeBaseFrecuencia)>0){
            ...
            $baseFrecuencia = PgrpSeguridadLineaBase::create([
                'pgrp_seguridades_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia Frecuencia',
             ]);
        }
    ...
    private function lineaBaseSeveridad($idPgrp,$arrSeveridad){
        $existeBaseSeveridad = PgrpSeguridadLineaBase::where('pgrp_seguridades_id',$idPgrp)
                ->where('nombreMeta','Eficacia Severidad')
                ->get();
        ...
        if(count($existeBaseSeveridad)>0){
            ...
            $baseSeveridad = PgrpSeguridadLineaBase::create([
                'pgrp_seguridades_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia Severidad',
             ]);
        }
    ...
    private function lineaBaseIli($idPgrp,$arrIli){
        $existeBaseili = PgrpSeguridadLineaBase::where('pgrp_seguridades_id',$idPgrp)
                ->where('nombreMeta','Eficacia ili')
                ->get();
        ...
        if(count($existeBaseili)>0){
            ...
            $baseili = PgrpSeguridadLineaBase::create([
                'pgrp_seguridades_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia ili',
             ]);
        }
    ...
    private function lineaBaseMortalidad($idPgrp,$arrMortalidad){
        $existeBaseTasaMortalidad = PgrpSeguridadLineaBase::where('pgrp_seguridades_id',$idPgrp)
                ->where('nombreMeta','Eficacia Tasa Mortalidad')
                ->get();
        ...
        if(count($existeBaseTasaMortalidad)>0){
            ...
            $baseTasaMortalidad = PgrpSeguridadLineaBase::create([
                'pgrp_seguridades_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia Tasa Mortalidad',
             ]);
        }
