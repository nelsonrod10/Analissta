...
use App\PlanesGestion\PgrpFisicoLineaBase;
use App\PlanesGestion\PgrpFisicoMeta;

class PgrpFisicoController extends Controller
{
    public function guardarData(){
        ...
        PgrpFisico::where('id',$data['idPgrp'])
    ...
    private function guardarMetasFrecuencia($idPgrp,$objetivo,$meta,$unidad){
        $existeFrecuencia = PgrpFisicoMeta::where('pgrp_fisicos_id',$idPgrp)
        ...
        PgrpFisicoMeta::create([
           "nombreMeta" => 'Eficacia Frecuencia',
           "pgrp_fisicos_id" => $idPgrp, 
           "objetivo" => $objetivo,
           "unidad"   => $unidad,
           "valorMeta"     => $meta, 
        ]);
    ...
    private function guardarMetasSeveridad($idPgrp,$objetivo,$meta,$unidad){
        $existeSeveridad = PgrpFisicoMeta::where('pgrp_fisicos_id',$idPgrp)
    ...
    private function guardarMetasIli($idPgrp,$objetivo,$meta,$unidad){
        $existeili = PgrpFisicoMeta::where('pgrp_fisicos_id',$idPgrp)
    ...
    private function guardarMetasMortalidad($idPgrp,$objetivo,$meta,$unidad){
        $existeTasaMortalidad = PgrpFisicoMeta::where('pgrp_fisicos_id',$idPgrp)
    ...
    private function lineaBaseFrecuencia($idPgrp,$arrFrecuencia){
        $existeBaseFrecuencia = PgrpFisicoLineaBase::where('pgrp_fisicos_id',$idPgrp)
                ->where('nombreMeta','Eficacia Frecuencia')
                ->get();
        ...
        if(count($existeBaseFrecuencia)>0){
            ...
            $baseFrecuencia = PgrpFisicoLineaBase::create([
                'pgrp_fisicos_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia Frecuencia',
             ]);
        }
    ...
    private function lineaBaseSeveridad($idPgrp,$arrSeveridad){
        $existeBaseSeveridad = PgrpFisicoLineaBase::where('pgrp_fisicos_id',$idPgrp)
                ->where('nombreMeta','Eficacia Severidad')
                ->get();
        ...
        if(count($existeBaseSeveridad)>0){
            ...
            $baseSeveridad = PgrpFisicoLineaBase::create([
                'pgrp_fisicos_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia Severidad',
             ]);
        }
    ...
    private function lineaBaseIli($idPgrp,$arrIli){
        $existeBaseili = PgrpFisicoLineaBase::where('pgrp_fisicos_id',$idPgrp)
                ->where('nombreMeta','Eficacia ili')
                ->get();
        ...
        if(count($existeBaseili)>0){
            ...
            $baseili = PgrpFisicoLineaBase::create([
                'pgrp_fisicos_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia ili',
             ]);
        }
    ...
    private function lineaBaseMortalidad($idPgrp,$arrMortalidad){
        $existeBaseTasaMortalidad = PgrpFisicoLineaBase::where('pgrp_fisicos_id',$idPgrp)
                ->where('nombreMeta','Eficacia Tasa Mortalidad')
                ->get();
        ...
        if(count($existeBaseTasaMortalidad)>0){
            ...
            $baseTasaMortalidad = PgrpFisicoLineaBase::create([
                'pgrp_fisicos_id' => $idPgrp,
                'nombreMeta'      => 'Eficacia Tasa Mortalidad',
             ]);
        }
