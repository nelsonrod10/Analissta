...
class CapacitacionesSugeridasController extends Controller
{
    public function verCapacitacion($id){
        ...
        $capacitacion = CapacitacionesObligatoriasSugerida::where('id',$id)
                        ...
                        ->get();
        return view('analissta.Capacitaciones.capacitacionSugerida')->with(['capacitacion'=>$capacitacion[0]]);
    }
    ...
    public function crearCapacitacionSugerida(){
