...
class ActividadesSugeridasController extends Controller
{
    public function verActividad($id){
        ...
        $actividad = ActividadesObligatoriasSugerida::where('id',$id)
                        ...
                        ->get();
        return view('analissta.Actividades.actividadSugerida')->with(['actividad'=>$actividad[0]]);
    }
    ...
    public function crearActividadSugerida(){
