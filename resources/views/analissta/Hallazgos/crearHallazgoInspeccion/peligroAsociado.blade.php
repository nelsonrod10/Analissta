...
@section('content')
    ...
    <br/>
    <form id="frm-nuevoPeligroDataGral" name="frm-nuevoPeligroDataGral" method="POST" action="{{ route('crear-peligro-asociado-hallazgo-inspeccion',["idInspeccion"=>$inspeccion->id,"tipoInspeccion"=>$inspeccion->medida,"idHallazgo"=>$idHallazgo])}}">
        {{ csrf_field() }}
        <br/>
