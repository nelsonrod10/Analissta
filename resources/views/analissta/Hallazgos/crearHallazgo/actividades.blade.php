                ...
                <div class="columns small-12 medium-10 small-centered">
                    ...
                    @if(count($actividadesBD) > 0)
                        ...
                        <div class="row text-center">
                            ...
                            <div class="columns small-4 end"><a class="button tiny alert" href="{{route('eliminar-actividad-hallazgo',['idHallazgo'=>$idHallazgo, 'idActividad'=>$actividad->id])}}">Eliminar</a></div>
                        </div>
                        @endforeach
                    @else
            ...
            <div class="row">
                <div class="columns small-12 medium-8 small-centered">
                    <fieldset class="fieldset">
                        <form name="frm-crearActividad-hallazgo" method="POST" action="{{route('crear-actividades-hallazgo',["id"=>$idHallazgo])}}">
                            {{ csrf_field() }}
            ...
            <div class="row text-center">
                <div class="columns small-12" data-tabs="">
                    ...
                    @if(count($actividadesBD) > 0)
                        ...
                        @else
                            <a class="button small success" href="{{route('capacitaciones-hallazgo',["id"=>$idHallazgo])}}">Siguiente</a>
                        @endif
                    @endif    
                </div>
            </div>
