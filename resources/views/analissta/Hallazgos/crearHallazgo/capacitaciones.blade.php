                    ...
                    <div class="columns small-12 label secondary text-center">Listado Capacitaciones</div>
                        ...
                        @if(count($capacitacionesBD) > 0)
                            ...
                            <div class="row text-center">
                                ...
                                <div class="columns small-4 end"><a class="button tiny alert" href="{{route('eliminar-capacitacion-hallazgo',['idHallazgo'=>$idHallazgo, 'idCapacitacion'=>$capacitacion->id])}}">Eliminar</a></div>
                            </div>
                            @endforeach
                        @else
            ...
            <div class="row">
                <div class="columns small-12 medium-8 small-centered">
                    <fieldset class="fieldset">
                        <form name="frm-crearActividad-hallazgo" method="POST" action="{{route('crear-capacitaciones-hallazgo',["id"=>$idHallazgo])}}">
                            {{ csrf_field() }}
            ...
            <div class="row text-center">
                <div class="columns small-12" data-tabs="">
                    @if($hallazgoBD->planAccion == "Capacitaciones")
                        <a class="button small" href="{{ route('acciones-hallazgo',["id"=>$idHallazgo]) }}">Anterior</a>
                    @else
                        <a class="button small" href="{{ route('actividades-hallazgo',["id"=>$idHallazgo]) }}">Anterior</a>
                    @endif
