...
@section('content')
    ...
    <div class="row">
        <div class="columns small-12 medium-8 small-centered">
            <form method="post" name="accionesHallazgo" action="{{route('crear-acciones-hallazgo',['id'=>$idHallazgo])}}">
                {{ csrf_field() }}
                ...
                <div class="row text-center">
                    <div class="columns small-12" data-tabs="">
                        <a class="button small" href="{{ route('causas-basicas-hallazgo',['id'=>$idHallazgo]) }}">Anterior</a>
