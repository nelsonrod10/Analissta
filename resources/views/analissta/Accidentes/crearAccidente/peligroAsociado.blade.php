...
@section('content')
    ...
    <br/>
    <form id="frm-nuevoPeligroDataGral" name="frm-nuevoPeligroDataGral" method="POST" action="{{ route('crear-peligro-asociado-accidente',["id"=>$idAccidente])}}">
        {{ csrf_field() }}
        <br/>
        ...
        <div class="row text-center">
            <div class="columns small-12" data-tabs="">
                <a class="button small" href="{{ route('afectacion-fuente-accidente',["id"=>$idAccidente]) }}">Anterior</a>
