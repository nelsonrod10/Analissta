    ...
    <div class="row">
        ...
        <div class="row">
            <div class="columns small-12 text-center" >
                ...
                <div class="small reveal" data-reveal="" id="reveal-programar-inspeccion">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('programar-inspeccion',['id'=>$inspeccion->id,'tipo'=>'obligatoria'])}}">Continuar</a>
                ...
                <div class="small reveal" data-reveal="" id="reveal-eliminar-inspeccion">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('eliminar-inspeccion-obligatoria',['id'=>$inspeccion->id])}}" >Confirmar</a>
                        <a class="button small alert" data-close="">Cancelar</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div id="div-presupuesto" class="columns small-12" >
                @include('analissta.Inspecciones.presupuestoInspecciones',['tabla_origen'=>'inspecciones_obligatorias_sugeridas','tipo'=>'obligatoria','origen'=>'inspeccion-obligatoria'])
            </div>
            <div class="columns small-12 text-center">
                <br/><br/>
                ...
                <a data-idDiv="0" class="button small success-2" href="{{route('ejecucion-inspeccion',['id'=>$inspeccion->id,'tipo'=>'obligatoria'])}}">Ejecucion</a>
            </div>
        </div>    
        @endif
    </div>
