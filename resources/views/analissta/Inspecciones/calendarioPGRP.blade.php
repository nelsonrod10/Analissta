    ...
    <div class="row">
        ...
        <div class="columns small-10">
            <?php
                ...
                foreach($arrInspeccionesFis as $idActividad):
                    $programadas = InspeccionesCalendario::where('sistema_id',$sistema->id)
                        ->where('inspeccion_id',$idActividad)
    ...
    <div class="row">
        ...
        <div class="columns small-10">
            <?php
                ...
                foreach($arrInspeccionesSeg as $idActividadSeg):
                    $programadasSeg = InspeccionesCalendario::where('sistema_id',$sistema->id)
                        ->where('inspeccion_id',$idActividadSeg)
                        ->where('tipo','valoracion')
                        ->where('anio',helpers::getCurrentYear())
                        ->where('mes',$textMes)
                        ->get();
    ...
    <div class="row">
        ...
        <div class="columns small-10">
            <?php
                ...
                foreach($arrInspeccionesGen as $idActividadGen):
                    $programadasGen = InspeccionesCalendario::where('sistema_id',$sistema->id)
                        ->where('inspeccion_id',$idActividadGen)
                        ->where('tipo','valoracion')
                        ->where('anio',helpers::getCurrentYear())
                        ->where('mes',$textMes)
                        ->get();
