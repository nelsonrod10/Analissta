...
<div class="row">
    <div class="columns small-12 medium-8 small-centered">
        <form id="frm-nuevoPeligroCriterios" name="frm-nuevoPeligroCriterios" method="POST" action="{{ route('guardar-criterios-revaloracion',['id'=>$peligro]) }}">
            {{ csrf_field() }}  
            ...
            <div class="row text-center">
                <div class="columns small-12" data-tabs="">
                    <a class="button small" href="{{ route('revaloracion-peligro',['id'=>$peligro])}}">Anterior</a>
