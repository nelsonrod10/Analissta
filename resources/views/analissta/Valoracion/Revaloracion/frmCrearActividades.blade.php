            ...
            @foreach($actividadesValoracion as $actividadValoracion)
                <div class="row">
                    ...
                    <div class="columns small-3 end">
                        <form name="frm-eliminar-actividad" method="post" action="{{ route('eliminar-medida-intervencion-revaloracion',['idPeligro'=>$peligro])}}">
                            {{ csrf_field() }}  
        ...
        <div class="columns small-12 small-centered ">
            @if(count($actividadesDisponibles)>0)
                @foreach($actividadesDisponibles as $actividadDisponible)
                    @php
                        $actividadProgramada = ActividadesValoracione::where('peligro_id',$peligro->id)
                    ...
                    <div class="row">
                        ...
                        <div class="columns small-5 text-left">
                            ...
                            @else
                                <form name="frm-eliminar-actividad" method="post" action="{{ route('crear-medida-intervencion-revaloracion',['idPeligro'=>$peligro]) }}">
                                    {{ csrf_field() }}  
