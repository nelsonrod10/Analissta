    ...
    <div class="row">
        ...
        <div class="row">
            <div class="columns small-12 text-center" >
                ...
                <div class="small reveal" data-reveal="" id="reveal-programar-actividad">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('programar-actividad',['id'=>$actividad->id,'tipo'=>'obligatoria'])}}">Continuar</a>
                ...
                <div class="small reveal" data-reveal="" id="reveal-eliminar-actividad">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('eliminar-actividad-obligatoria',['id'=>$actividad->id])}}" >Confirmar</a>
                        <a class="button small alert" data-close="">Cancelar</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="columns small-12">
                        @foreach($empresa->centrosTrabajo as $centro)
                            @php
                                $calendarioCentro = ActividadesCalendario::where('sistema_id',session('sistema')->id)  
                            ...
                            @if(count($calendarioCentro) > 0)
                                ...
                                ?>        
                                    <div class="row">
                                        ...
                                        <?php
                                            $semanas = ActividadesCalendario::where('sistema_id',session('sistema')->id)  
                                            ->where('centroTrabajo_id',$centro->id)
                                            ->where('actividad_id',$actividad->id)
                                            ->where('tipo','obligatoria')
                                            ->where('mes',$mes)
            ...
            <div id="div-presupuesto" class="columns small-12" >
                @include('analissta.Actividades.presupuestoActividades',['tabla_origen'=>'actividades_obligatorias_sugeridas','tipo'=>'obligatoria','origen'=>'actividad-obligatoria'])
            </div>
            <div class="columns small-12 text-center">
                <br/><br/>
                ...
                <a data-idDiv="0" class="button small success-2" href="{{route('ejecucion-actividad',['id'=>$actividad->id,'tipo'=>'obligatoria'])}}">Ejecución</a>
            </div>
        </div>    
        @endif
    </div>
