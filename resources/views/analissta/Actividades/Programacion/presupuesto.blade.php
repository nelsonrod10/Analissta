        ...
        <div class="columns small-12 medium-8 small-centered">
            ...
            <div id="div-addItem-presupuesto">
                ...
                switch ($tipoActividad) {
                    case $tipoActividad === 'obligatoria' || $tipoActividad === 'sugerida':
                        $table = 'actividades_obligatorias_sugeridas';
                        break;  
                    case 'valoracion':
                        $table = 'actividades_valoraciones';
                        break;
                    case 'hallazgo':
                        $table = 'actividades_hallazgos';
                        break;
                    default:
                        break;
                }
                    ...
                    <div class="row">
                        ...
                        <div class="columns small-12 medium-2">
                            <form method="post" name="frm-presupuesto" action="{{route('eliminar-item-presupuesto')}}">
                                ...
                                <input type="hidden" name="origen" value="programacion-presupuesto-actividad"/>
            ...
            <div class="columns small-12 callout success hide" id="frm-presupuesto">
                <form method="post"  name="frmProgramarIntervencion-Paso-3" action="{{route('presupuesto-actividad')}}">
                    {{ csrf_field() }}
                    <input type="hidden" name="tipo" value="{{$tipoActividad}}"/>
                    <input type="hidden" name="idActividad" value="{{$actividad->id}}"/>
                    <input type="hidden" name="origen" value="programacion-presupuesto-actividad"/>
            ...
            <div id="botones-finalizar">
                ...
                <div class="row columns text-center">
                    <a class="button small" href="{{ route('ver-programacion-actividad',['id'=>$actividad->id,'tipo'=>$tipoActividad])}}">Anterior</a>
                    <a class="button small alert" data-open="reveal-cancelar-programacion-actividad">Cancelar</a>
                    <a class="button small success-2" href="{{route('finalizar-programar-actividad',['id'=>$actividad->id,'tipo'=>$tipoActividad])}}">Finalizar</a>
                </div>    
            </div>
