    ...
    <div class="row">
        ...
        @if($actividad->estado === '')
            <div class="columns small-12 text-center" >
                ...
                <div class="small reveal" data-reveal="" id="reveal-programar-actividad">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('programar-actividad',['id'=>$actividad->id,'tipo'=>'valoracion'])}}">Continuar</a>
        ...
        <div class="row">
            <div class='columns small-12'>
                ...
                <?php
                    $peligrosAsociados = Peligro::where('id',$actividad->peligro_id)->get();
                ?>
                <ul>
        ...
        <div class="row">
            ...
            <div id="div-presupuesto" class="columns small-12" >
                @include('analissta.Actividades.presupuestoActividades',['tabla_origen'=>'actividades_valoraciones','tipo'=>'valoracion','origen'=>'actividad-valoracion'])
            ...
            <div class="columns small-12 text-center">
                ...
                <a data-idDiv="0" class="button small success-2" href="{{route('ejecucion-actividad',['id'=>$actividad->id,'tipo'=>'valoracion'])}}">Ejecución</a>
            </div>
        </div>
        @endif
    </div>
