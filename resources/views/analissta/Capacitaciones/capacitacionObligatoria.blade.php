    ...
    <div class="row">
        ...
        <div class="row">
            <div class="columns small-12 text-center" >
                ...
                <div class="small reveal" data-reveal="" id="reveal-programar-capacitacion">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('programar-capacitacion',['id'=>$capacitacion->id,'tipo'=>'obligatoria'])}}">Continuar</a>
                ...
                <div class="small reveal" data-reveal="" id="reveal-eliminar-capacitacion">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('eliminar-capacitacion-obligatoria',['id'=>$capacitacion->id])}}" >Confirmar</a>
                        <a class="button small alert" data-close="">Cancelar</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="columns small-12" style="border-right: 3px solid lightgrey">
                ...
                <div class="row">
                    <div class="columns small-12"><b>Temario</b></div>
                    <div class="columns small-12">
                        <textarea style="min-height: 80px" disabled="true">{{$capacitacion->temario}}</textarea>
                    </div>
                </div>
            ...
            <div class="columns small-12 medium-12">
                ...
                <div class="row">
                    <div class="columns small-2"><b>Capacitador:</b></div>
                    <div class="columns small-2 end">{{$capacitacion->capacitador}}</div>
                </div>
                <div class="row">
                    <div class="columns small-2"><b>Evaluable: </b></div>
                    <div class="columns small-2 end">{{$capacitacion->evaluable}}</div>
                </div>
                <div class="row">
                    <div class="columns small-2"><b>% Total de ejecución</b></div>
            ...
            <div id="div-presupuesto" class="columns small-12" >
                @include('analissta.Capacitaciones.presupuestoCapacitaciones',['tabla_origen'=>'capacitaciones_obligatorias_sugeridas','tipo'=>'obligatoria','origen'=>'capacitacion-obligatoria'])
            </div>
            <div class="columns small-12 text-center">
                <br/><br/>
                ...
                <a data-idDiv="0" class="button small success-2" href="{{route('ejecucion-capacitacion',['id'=>$capacitacion->id,'tipo'=>'obligatoria'])}}">Ejecucion</a>
            </div>
        </div>    
        @endif
    </div>
