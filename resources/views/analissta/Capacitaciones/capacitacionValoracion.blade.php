    ...
    <div class="row">
        ...
        @if($capacitacion->estado === '')
            <div class="columns small-12 text-center" >
                ...
                <div class="small reveal" data-reveal="" id="reveal-programar-capacitacion">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('programar-capacitacion',['id'=>$capacitacion->id,'tipo'=>'valoracion'])}}">Continuar</a>
                    ...
                    <li>
                        <small>
                            <a href="{{route('detalles-peligro',['idActividad'=>$peligro->actividad->id,'idPeligro'=>$peligro->id])}}">
                                <b>{{$clasificacion[0]->nombre}} - {{$categoria[0]->nombre}}, Capacitacion</b>: {{$peligro->actividad->nombre}}, <b>Proceso:</b> {{$peligro->actividad->proceso->nombre}}
                            </a>
                        </small>
                    </li>
                    @endforeach
        ...
        <div class="row">
            ...
            <div id="div-presupuesto" class="columns small-12" >
                @include('analissta.Capacitaciones.presupuestoCapacitaciones',['tabla_origen'=>'capacitaciones_valoraciones','tipo'=>'valoracion','origen'=>'capacitacion-valoracion'])
            </div>
            <div class="columns small-12 text-center">
                <br/><br/>
                ...
                <a data-idDiv="0" class="button small success-2" href="{{route('ejecucion-capacitacion',['id'=>$capacitacion->id,'tipo'=>'valoracion'])}}">Ejecucion</a>
            </div>
        </div>
        @endif
    </div>
