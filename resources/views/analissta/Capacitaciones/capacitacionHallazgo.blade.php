    ...
    <div class="row">
        ...
        <div class="row">
            <div class='columns small-12 medium-7 small-centered text-center'>
                <div class="fieldset">
                    ...
                    <div><b><i>**Esta Capacitación esta asociada con un Hallazgo</i></b></div>
                    <br/>
                    <div><a href="{{route('hallazgo',['id'=>$capacitacion->hallazgo_id])}}" class="button small">Ver Hallazgo</a></div>
                </div>
            </div>
        </div>
        @if($capacitacion->estado === '')
            <div class="columns small-12 text-center" >
                ...
                <div class="small reveal" data-reveal="" id="reveal-programar-capacitacion">
                    ...
                    <br/>
                    <div class="row columns text-center">
                        <a class="button small success-2" href="{{route('programar-capacitacion',['id'=>$capacitacion->id,'tipo'=>'hallazgo'])}}">Continuar</a>
        ...
        <div class="row">
            ...
            <div id="div-presupuesto" class="columns small-12" >
                @include('analissta.Capacitaciones.presupuestoCapacitaciones',['tabla_origen'=>'capacitaciones_hallazgos','tipo'=>'hallazgo','origen'=>'capacitacion-hallazgo'])
            </div>
            <div class="columns small-12 text-center">
                <br/><br/>
                ...
                <a data-idDiv="0" class="button small success-2" href="{{route('ejecucion-capacitacion',['id'=>$capacitacion->id,'tipo'=>'hallazgo'])}}">Ejecucion</a>
            </div>
        </div>
        @endif
    </div>
