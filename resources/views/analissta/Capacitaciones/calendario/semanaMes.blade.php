...
@section('content')
    ...
    <div class="row columns text-center" >
        <h5 style="background:#acafaf;color: white">Calendario de Capacitaciones {{$mes}} - Semana {{$semana}}</h5>
    </div>
    ...
    <div class="row text-center">
        <a href="{{route('calendario-capacitaciones-mes',['mes'=>$mes])}}" class="button small">Calendario {{$mes}}</a>
