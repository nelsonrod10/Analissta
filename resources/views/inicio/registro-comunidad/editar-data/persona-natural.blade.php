        ...
        <div class="container">
            <div class="row heading">
                <div class="col-md-10 col-md-offset-1">
                    <form method="POST" action="{{route('comunidad-profesionales.update',$miembro)}}">
                        {{ csrf_field() }}
                        {{method_field('PUT')}}
                        <input type="hidden" hidden="" class="hide" name="tipo" value="natural"/>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                              <label>1. Nombres y Apellidos <small style="color:#eb6666" class="form-text text-muted">(obligatorio)</small></label>
                              <input type="text" class="form-control" value="{{$miembro->nombre}}" name="nombre" placeholder="Nombres y Apellidos" required>

                            </div>
                            <div class="form-group col-md-6">
                              <label >2. Profesión  <small style="color:#eb6666" class="form-text text-muted">(obligatorio)</small></label>
                              <input type="text" class="form-control" value="{{$miembro->profesion}}" name="profesion" placeholder="Ingeniero, Médico, Técnico, Tecnólogo etc..." required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label>4. Email  <small style="color:#eb6666" class="form-text text-muted">(obligatorio)</small></label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                              <label>7. Descripción Perfil:</label>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('comunidad-profesionales.destroy',$miembro)}}">
                {{csrf_field()}}
                {{method_field("DELETE")}}
