...
class CreateActividadesCalendariosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('actividades_calendarios', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('actividades_calendarios');
    }
}
