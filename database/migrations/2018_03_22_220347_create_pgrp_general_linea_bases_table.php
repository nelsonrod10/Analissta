...
class CreatePgrpGeneralLineaBasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pgrp_general_linea_bases', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pgrp_general_linea_bases');
    }
}
