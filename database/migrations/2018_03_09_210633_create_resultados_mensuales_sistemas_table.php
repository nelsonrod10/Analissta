...
class CreateResultadosMensualesSistemasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('resultados_mensuales_sistemas', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('resultados_mensuales_sistemas');
    }
}
