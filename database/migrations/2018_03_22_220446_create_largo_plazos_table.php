...
class CreateLargoPlazosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('largo_plazos', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->enum('pve',['Si','No'])->default('No');
            $table->integer('pve_id')->default(0);
            $table->enum('pve_table',['N/A','pve_fisicos','pve_seguridades','pve_generales'])->default("N/A");
    ...
    {
        Schema::dropIfExists('largo_plazos');
    }
}
