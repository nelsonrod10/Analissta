...
class CreatePgrpSeguridadLineaBasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pgrp_seguridad_linea_bases', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pgrp_seguridad_linea_bases');
    }
}
