...
class CreatePveFisicoLineaBasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pve_fisico_linea_bases', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pve_fisico_linea_bases');
    }
}
