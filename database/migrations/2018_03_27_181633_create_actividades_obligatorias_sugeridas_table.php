...
class CreateActividadesObligatoriasSugeridasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('actividades_obligatorias_sugeridas', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('actividades_obligatorias_sugeridas');
    }
}
