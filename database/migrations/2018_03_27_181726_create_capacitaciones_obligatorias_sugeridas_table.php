...
class CreateCapacitacionesObligatoriasSugeridasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('capacitaciones_obligatorias_sugeridas', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('sistema_id')->unsigned();
            $table->enum('medida',['N/A','obligatoria','sugerida'])->defaul('N/A');
    ...
    {
        Schema::dropIfExists('capacitaciones_obligatorias_sugeridas');
    }
}
