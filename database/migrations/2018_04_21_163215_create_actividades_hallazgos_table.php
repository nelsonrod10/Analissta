...
class CreateActividadesHallazgosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('actividades_hallazgos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('actividades_hallazgos');
    }
}
