...
class CreatePveSeguridadLineaBasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pve_seguridad_linea_bases', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pve_seguridad_linea_bases');
    }
}
